...
The Emoji artwork is a derivative of the Noto Emoji \textbf{BRAIN} \texttt{U+1F9E0} glyph which uses \myhref{https://github.com/googlei18n/noto-emoji/blob/master/LICENSE}{Apache License, version 2.0}. A copy of that license is included in the zip archive.
